    ...
    <div className="min-h-screen bg-background text-foreground selection:bg-gold/30">
      ...
      <div className="bg-charcoal text-white text-[11px] py-2 px-4 border-b border-white/10 flex items-center justify-between font-label">
        <div className="flex items-center gap-2 mx-auto sm:mx-0">
          ...
          <span className="tracking-widest uppercase text-gold font-medium">Maison Fleurie Paris</span>
        ...
        <div className="hidden sm:flex items-center gap-4">
          ...
          >
            ...
            <span className="font-medium">Directeur / Salon Portal</span>
          </Link>
        </div>
      </div>
      ...
      <header className="sticky top-0 z-40 bg-surface/90 glass-surface border-b border-border/80 px-4 sm:px-8 py-3.5 transition-all">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <Link href="/" className="flex items-center gap-3 group">
            <div className="flex h-10 w-10 items-center justify-center rounded-2xl bg-gold-surface border border-gold-border text-gold font-serif font-bold text-lg shadow-sm group-hover:scale-105 transition-transform">
              MF
            </div>
            <div>
          ...
          <nav className="hidden md:flex items-center gap-6 text-xs uppercase font-label tracking-widest text-muted-foreground">
            ...
            <Link href="/dashboard" className="hover:text-gold transition-colors flex items-center gap-1 text-gold">
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="p-2 rounded-full text-muted-foreground hover:text-foreground hover:bg-surface-muted transition-colors border border-border/50"
            >
